...
export default async function Dashboard() {
  ...
  return (
    <>
      <h2>{property.name}</h2>
      <p>{property.address} · Managed by {property.manager} · {month}</p>
      <div className="cards">
      ...
      <section className="panel">
        ...
        <p>Leasing focus is Units 1 and 2 for the butchery offer, Unit 14, Whitehouse and the Bar prospect at USD1,300. Arrears focus is Luna's Shop and Alvatron Electronics reconciliation.</p>
      </section>
    </>
  );
}
